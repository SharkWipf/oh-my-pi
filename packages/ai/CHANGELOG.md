...
- Preserve Anthropic source and original-image origins through text, tool exchanges, compaction replay, and cache-control copies. Native compaction blocks retain aggregate provenance rather than claiming exact original-source content.
