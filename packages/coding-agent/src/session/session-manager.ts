...
class SessionEntryIndex {
	...
	#cloneFold(fold: SessionBranchFold): SessionBranchFold {
		...
		return { id: fold.id, controls: cloneSessionContextControlState(fold.controls), pins };
	}
...
export class SessionManager {
	...
	buildSessionContext(options?: BuildSessionContextOptions): SessionContext {
		...
		return buildSessionContextFromPath(
			this.#index.contextPath(contextOptions),
			contextOptions,
			this.#index.branchFold().controls,
		);
	}
