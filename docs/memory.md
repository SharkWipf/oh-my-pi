...
TUI, ACP, RPC and print-mode commands share the session-owned actions. Views do not own background work. `omp --start-without-memory -p "/memory requirements help"` works without model credentials.
